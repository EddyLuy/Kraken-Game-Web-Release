...
aVI(d,e,f,g){return C.d.a9(d-e*0.5,f,Math.max(f,g-e))},
aLg(d,e,f,g,h,i,j,k,l){return new B.Rs(l,d,e,h,f,i,g,j,k)},
aVL(d,e){return A.bS(d.L(0,new A.c(e?92:-92,0)),105,184)},
aVK(d){var x
...
aRb(d){var x=d.a,w=d.b
return new B.mQ(x,x,w,w,d.c,d.d,!0,d.f)},
b24(d){return B.aRb(d)},
aVM(d){return new A.fO(B.bac(d),y.w)},
bac(d){return function(){var x=d
var w=0,v=1,u=[],t,s,r,q,p,o,n,m,l,k,j,i,h,g,f,e,a0,a1,a2,a3,a4,a5
return function $async$aVM(a6,a7,a8){if(a7===1){u.push(a8)
...
bad(d,e,f){var x=e.M(0,d)
if(x.gjq()<0.0001)return f.M(0,d).gaS()
return f.M(0,d.L(0,x.S(0,C.d.a9((f.M(0,d).a*x.a+f.M(0,d).b*x.b)/x.gjq(),0,1)))).gaS()},
aVJ(d,e,f){return d.M(0,new A.c(C.d.a9(d.a,f.a,f.c),C.d.a9(d.b,f.b,f.d))).gjq()<e*e},
Mt(d,e){var x,w,v,u,t,s,r,q,p,o,n,m=J.bn(e)
...
bab(d,e,f){var x,w,v,u
if(B.Mt(d,f))return!0
for(x=d.a,w=d.b,v=0;v<12;++v){u=6.283185307179586*v/12
if(B.Mt(new A.c(x+Math.cos(u)*e,w+Math.sin(u)*e),f))return!0}return!1},
aNf(d,e,f,g,h,i,j){var x,w=new B.aJ5(j,i,g,f),v=new A.c(C.d.a9(h.a+e.a,d.a+i,d.c-i),h.b)
if(!w.$1(v))v=h
...
u.fr=B.aVI(v,u.gpk(),x.d,x.e)
x=u.a.c.k2
v=A.a3(x).i("aa<1,mQ>")
x=A.a4(new A.aa(x,B.bae(),v),v.i("ay.E"))
u.ok!==$&&A.aK()
u.ok=x
u.AV()
u.AU()
...
for(v=new A.iW(B.aVM(v).a()),u=w.a,p=q/2;v.u();){o=v.b
n=o.b
m=o.a
J.a7(u.save())
u.clipRect(A.bo(new A.i(m.a,m.b-t,m.c,m.d)),$.h5()[1],!0)
l=n.a-p
k=n.b-t
...
t=v.n(0,C.au)||v.n(0,C.cu)
s=v.n(0,C.aU)||v.n(0,C.cv)
r=v.n(0,C.aZ)||v.n(0,C.cM)
v=t?1:0
q=u?1:0
p=r?1:0
o=s?1:0
...
m=e.dx
m===$&&A.a()
q=e.dx=B.aNf(new A.i(0,q.d,p,q.e),new A.c(v,n.b*(1.2*q.w*o/p)).S(0,570).S(0,w),D.jT,q.go,m,30,q.fy)
if(e.a.Q!=null){l=e.go?-1:1
v=e.dy
v===$&&A.a()
e.dy=K.aIy(v,w,4.8,new A.c(q.a+105*l,q.b+42))}v=e.dx
q=e.gpk()
p=e.a.c
e.fr=B.aVI(v.b,q,p.d,p.e)
if(!e.fx){v=e.a
q=v.c.fx
...
m=f.c
if(m<=0)continue
if(B.bad(i,h,f.a)<=B.aVK(f.f)){p=Math.max(0,f.c-50)
f.c=p
f.x=0.18
if(p<=0&&f.w)f.z=2.5
j.d=99
...
o.p4=1.1
p=r<0.001?C.dH:new A.c(-s/r,-t/r)
u=o.dx
q=q.c
o.dx=B.aNf(new A.i(0,q.d,q.c,q.e),new A.c(p.a*82,p.b*82),D.jT,q.go,u,30,q.fy)
if(o.p3<=0)o.apB()}continue}if(r>520)continue
u=v.a
q=o.a.c
v.a=B.aNf(new A.i(0,q.d,q.c,q.e),new A.c(s/r*105*d,t/r*105*d),D.jT,q.go,u,28,q.fy)}},
...
if(!B.aVJ(s.a,B.aVK(s.f),w))continue
u.F(0,s)
...
if(r<=0&&s.w)s.z=2.5}},
aov(d,e){var x=e.b
if(!A.c1([C.at,C.au,C.aU,C.aZ,C.c3,C.cu,C.cv,C.cM,C.bE],y.x).n(0,x))return C.ce
if(e instanceof A.fG)if(x.k(0,C.bE))this.Yi()
else this.f.F(0,x)
...
u=i.v1(e)
t=i.a.c
s=B.aLg(x,w,0,u,w+v,e.b,t.d,t.e,e)
t=s.e
r=s.d
q=s.c
p=s.y
...
r=this.ok
r===$&&A.a()
C.b.F(r,B.aRb(new B.iy(new A.c(t,s),160,!0,D.hS,!1)))}},
j(){var x=this,w=x.r
if(w!=null)w.aP()
x.d.j()
w=x.x
...
n=A.wt(p,p,p,F.uG,p,p,q.a.d,p,p,p,"Leave development map")
x=y.p
u=A.b([],x)
t=q.a
s=t.y
if(s!=null&&t.z!=null)u.push(A.W(s.toUpperCase()+" \u2022 LEVEL "+A.v(t.z),p,p,p,F.Gu,p,p,p))
u.push(A.W(q.a.c.a.toUpperCase(),p,p,p,L.Gx,p,p,p))
n=A.bD(p,q.Jx(A.bW(A.b([n,A.bs(u,C.b2,C.m,C.z)],x),C.n,p,C.m,C.z,0)),p,p,16,p,16,p)
u=A.bD(p,q.Jx(D.aqR),p,p,p,16,16,p)
t=q.a.r
s="TARGETS "+v
r=""+w.length
if(t)t=s+"/"+r+"  \u2022  TRAINING DAMAGE OFF"
else{t=y.N
t=s+"/"+r+"  \u2022  HEALTH "+(C.b.tz(A.bH(q.p3,"\u2665",!1,t))+C.b.tz(A.bH(5-q.p3,"\u2661",!1,t)))}t=A.b([o,n,u,A.bD(p,q.Jx(A.W(t,p,p,p,D.anA,p,p,p)),p,p,p,16,62,p)],x)
o=q.p4
if(o>0.82)t.push(A.f1(0,A.dE(A.fy(p,C.AO.bi(C.d.a9((o-0.82)/0.28,0,1)*0.24),!0),!0,p)))
t.push(A.bD(22,new B.ZH(q.gaku(),p),p,p,22,p,p,p))
o=q.k2
o=o<=0?"CLICK TO FIRE":C.d.ag(o,1)+"s"
t.push(A.bD(22,A.bW(A.b([new B.Jp(T.nG,o,new B.aBg(),p),C.ex,new B.Jp(D.UT,"SWORD",q.garO(),p)],x),C.n,p,C.m,C.z,0),p,p,p,22,p,p))
if(q.gVM()!=null)t.push(A.bD(28,A.cA(G.mv(D.Wz,D.aqw,q.galz(),A.aKw(p,D.NJ,C.i,D.Ta,D.If)),p,p),p,p,0,0,p,p))
return A.fz(!0,p,A.fZ(p,D.M7,A.bZ(C.a5,t,C.p,C.af,p)),p,p,p,q.d,!0,p,new B.aBh(q),p,q.gaou(),p,p)},
Jx(d){var x=null
return A.ha(new A.aA(M.tC,d,x),new A.bX(D.mf,x,H.eS(E.cD,1.5),A.dz(14),x,x,C.ab),C.bb)}}
B.Jp.prototype={
D(d){var x=null,w=H.eS(E.cD,2),v=A.dz(16)
return A.ik(x,A.eH(x,A.bs(A.b([A.cl(this.c,C.i,x,25),A.W(this.d,x,x,x,D.ap0,x,x,x)],y.p),C.n,C.cw,C.z),C.v,x,new A.bX(D.mf,x,w,v,x,x,C.ab),x,58,x,x,x,x,82),C.ax,!1,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,this.e,x,x,x,x,x,x)}}
B.ZH.prototype={
D(d){var x=this
return A.cU(A.bZ(C.a5,A.b([x.AT(53,0,D.V6,C.aU),x.AT(0,53,D.V4,C.at),x.AT(106,53,D.V5,C.au),x.AT(53,106,F.un,C.aZ)],y.p),C.p,C.af,null),154,154)},
AT(d,e,f,g){var x=null,w=H.eS(E.cD,2),v=A.dz(14)
return A.bD(x,A.lc(C.c2,A.eH(x,A.cl(f,C.i,x,34),C.v,x,new A.bX(D.mf,x,w,v,x,x,C.ab),x,48,x,x,x,x,48),new B.aAW(this,g),new B.aAX(this,g),x,x,new B.aAY(this,g)),x,x,d,x,e,x)}}
B.ZJ.prototype={
...
$.J()
x=A.K()
x.seZ(D.XG.i6(new A.i(0,0,a7,a8)))
...
r=a5/2-a3.b*a7
A.a4p(C.bA,C.r,a9,a4,a4,a4,C.a6,C.iI,!1,v,!1,!1,1,new A.i(r,s,r+u,s+t),C.d5,1)
...
a8=a6*0.54
x=A.K()
x.seZ(D.XK.i6(new A.i(0,w,a5,a8)))
a9.bm(new A.i(0,w,a5,a8),x)
p=a3.z
if(p!=null){a8=a6*0.47
J.a7(a7.save())
a7.clipRect(A.bo(new A.i(0,w,a5,a8)),$.h5()[1],!0)
...
a7.drawArc.apply(a7,[A.bo(new A.i(j,a1,j+92,a8)),21.599999999999998,136.79999999999998,!1,g])
g.delete()}}$.J()
a2=A.K()
a2.r=C.i.bi(0.72).gm()
for(a5=a6*0.16;o<x;o+=420){a6=A.bS(new A.c(o+190,a5),42,190)
g=a2.aI()
a7.drawOval(A.bo(a6),g)
g.delete()}a7.restore()},
cF(d){var x=this
return d.b!==x.b||d.c!==x.c||d.d!==x.d||d.e!==x.e||d.f!==x.f||d.w!==x.w||d.x!==x.x||d.y!=x.y||d.z!=x.z||d.Q!==x.Q}}
B.a18.prototype={
aq(d,e){var x,w,v,u,t,s,r=this,q=null,p=e.b,o=B.aLg(r.c,r.e,0,r.d,r.f,p,q,q,e).iU(r.b),n=e.ga2R()*0.78,m=Math.min(185,e.gem()*0.24),l=C.d.a9(m/n,0,0.8),k=C.d.a9((m+115)/n,l,0.92),j=e.a,i=0+j,h=0+p
$.J()
x=A.K()
...
j=A.K()
j.a=D.I2
j.seZ(I.acb(o,s,R.o6,D.YX,C.aJ,q,q,0))
d.bW(o,s,j)
p.restore()},
cF(d){var x=this
return!d.b.k(0,x.b)||d.c!==x.c||d.d!==x.d||d.e!==x.e||d.f!==x.f}}
B.ZI.prototype={
aq(d,e){var x,w,v,u,t,s,r,q=this,p=q.b,o=B.aLg(q.r,q.x,0,q.w,q.y,e.b,p.d,p.e,e)
if(p.x)q.anA(d,e,o)
q.anP(d,o)
x=A.b([],y.u)
...
u=A.K()
t=a2.e
u.seZ(D.XC.i6(new A.i(0,x,v,a6.iU(new A.c(0,t)).b)))
a4.dG(w,u)
s=this.go
if(s!=null){u=a4.a
J.a7(u.save())
...
x.r=D.Ph.gm()
k=x.aI()
f.drawRect(A.bo(new A.i(j,-39,j+25,-4)),k)
k.delete()}for(x=[-88,88],i=0;i<2;++i){w=x[i]-7
u=new A.b9(C.r,C.t,C.D,C.F,C.o)
u.r=D.Mi.gm()
k=u.aI()
f.drawRect(A.bo(new A.i(w,-58,w+14,8)),k)
k.delete()}break
case 6:h=A.K()
h.r=D.O8.gm()
d.bm(D.agw,h)
...
if(w.length===0||B.baa(d,x.b,w)){w=x.b
w=C.b.dq(x.c,new B.aJ6(d,w))&&C.b.dq(x.d,new B.aJ7(d,w))}else w=!1
return w},
$S:156}
B.aJ6.prototype={
$1(d){return!B.aVJ(this.a,this.b,d)},
$S:88}
B.aJ7.prototype={
$1(d){return!B.bab(this.a,this.b,d)},
$S:170}
B.aBi.prototype={
...
if(x!=null)x.j()
t.cx=t.acz(t.CW)
for(x=t.cy,w=0;w<7;++w){v=D.Zv[w]
u=s.E(0,"prop:"+v.b)
if(u!=null)x.p(0,v,u)}for(t=t.db,w=0;w<2;++w){v=D.a0X[w]
u=s.E(0,"enemy:"+v.b)
if(u!=null)t.p(0,v,u)}},
$S:0}
B.aB9.prototype={
...
$S:0}
B.aB3.prototype={
$1(d){var x=null,w=this.b,v=A.W(w?"Treasure Found":"An Empty Promise",x,x,x,D.anS,x,x,x),u=A.W(w?this.a.a.c.fr:this.c,x,x,x,D.anR,x,x,x)
return A.j1(A.b([A.h1(S.GA,new B.aB1(d),x)],y.p),x,D.Pz,u,x,v)},
$S:53}
B.aB1.prototype={
...
a7=a3.fr
a1.push(A.dE(A.dj(a2,a2,a2,new B.a18(a4,a9,a8,a7,a7+a3.gpk(),a2),C.E),!0,a2))}return A.ik(C.aO,A.bZ(C.a5,a1,C.p,C.cj,a2),C.ax,!1,a2,a2,a2,a2,a2,a2,a2,a2,a2,a2,a2,a2,a2,a2,a2,a2,a2,a2,new B.aBc(a3,b3),a2,a2,a2,a2)},
$S:613}
B.aBc.prototype={
$1(d){var x=this.b
...
v.toString
return K.aJ3(this.b,w,v,x.f,36.96,x.z)},
$S:0}
B.aBn.prototype={
...
x(A.P,[B.Rs,B.x7,B.iy,B.mQ,B.bk,B.x6])
x(A.iT,[B.oU,B.iz])
x(A.dJ,[B.aJ5,B.aJ6,B.aJ7,B.aBi,B.aBj,B.aB9,B.aBa,B.aB7,B.aB8,B.aB3,B.aBd,B.aBe,B.aBh,B.aBc,B.aAX,B.aAY,B.aAW])
w(B.Ed,A.V)
w(B.Jq,A.Z)
...
return{q:x("a8<~>"),I:x("d0"),O:x("m<h>"),k:x("m<a8<d0>>"),g:x("m<c>"),v:x("m<c8>"),F:x("m<x7>"),u:x("m<+depth,horizontalOrder,paint(G,G,~())>"),p:x("m<f>"),n:x("m<G>"),x:x("k"),o:x("c"),W:x("mQ"),A:x("oU"),m:x("bk"),e:x("iz"),N:x("I"),w:x("fO<+obstacle,point(i,c)>"),H:x("~")}})();(function constants(){var x=a.makeConstList
D.I2=new A.m9(8,"dstOut")
D.If=new A.aX(E.cD,2,C.G,-1)
D.Ln=new A.h(1,0.13725490196078433,0.37254901960784315,0.25882352941176473,C.c)
D.Lw=new A.h(1,0.2784313725490196,0.47843137254901963,0.4470588235294118,C.c)
D.LE=new A.h(1,0.5058823529411764,0.4588235294117647,0.5647058823529412,C.c)
D.iQ=new A.h(1,0.9098039215686274,0.7176470588235294,1,C.c)
D.LQ=new A.h(1,0.7098039215686275,0.40784313725490196,0.8313725490196079,C.c)
D.LU=new A.h(1,0.1803921568627451,0.4627450980392157,0.3176470588235294,C.c)
D.M4=new A.h(1,0.4117647058823529,0.38823529411764707,0.33725490196078434,C.c)
D.M7=new A.h(1,0.00784313725490196,0.0392156862745098,0.07058823529411765,C.c)
D.Md=new A.h(1,0.5450980392156862,0.30980392156862746,0.1411764705882353,C.c)
D.Mg=new A.h(1,0.15294117647058825,0.30196078431372547,0.28627450980392155,C.c)
D.Mi=new A.h(1,0.29411764705882354,0.18823529411764706,0.11372549019607843,C.c)
D.MO=new A.h(1,0.23921568627450981,0.23137254901960785,0.2901960784313726,C.c)
D.MY=new A.h(1,0.4392156862745098,0.27058823529411763,0.13333333333333333,C.c)
D.NJ=new A.h(1,0.7137254901960784,0.41568627450980394,0.12549019607843137,C.c)
D.NL=new A.h(1,0.3686274509803922,0.42745098039215684,0.6274509803921569,C.c)
D.NV=new A.h(1,0.2196078431372549,0.15294117647058825,0.09803921568627451,C.c)
D.O4=new A.h(1,1,0.8,0.3333333333333333,C.c)
D.O8=new A.h(1,0.4235294117647059,0.44313725490196076,0.40784313725490196,C.c)
D.Oz=new A.h(0.2,1,0.9411764705882353,0.6901960784313725,C.c)
D.mf=new A.h(0.8784313725490196,0.03137254901960784,0.13333333333333333,0.18823529411764706,C.c)
D.OH=new A.h(1,1,0.9490196078431372,0.6588235294117647,C.c)
D.OT=new A.h(0.3333333333333333,1,0.8235294117647058,0.3686274509803922,C.c)
D.OY=new A.h(1,0.09019607843137255,0.24313725490196078,0.19215686274509805,C.c)
D.Pc=new A.h(0.3333333333333333,1,0.8431372549019608,0.41568627450980394,C.c)
D.Pg=new A.h(0.2,0.4392156862745098,0.2784313725490196,0.16470588235294117,C.c)
D.Ph=new A.h(1,0.6470588235294118,0.4196078431372549,0.19607843137254902,C.c)
D.Px=new A.h(1,0.09019607843137255,0.30980392156862746,0.2196078431372549,C.c)
D.Pz=new A.h(1,0.06274509803921569,0.1607843137254902,0.21176470588235294,C.c)
D.Qc=new A.h(1,0.0784313725490196,0.12549019607843137,0.1568627450980392,C.c)
D.Ta=new A.aj(22,14,22,14)
D.Tr=new A.ig(C.i,P.lF,null,C.e2)
D.UT=new A.am(57725,"MaterialIcons",!1)
D.V4=new A.am(58196,"MaterialIcons",!1)
D.V5=new A.am(58197,"MaterialIcons",!1)
D.V6=new A.am(58198,"MaterialIcons",!1)
D.Wz=new A.aP(N.ec,null,null,null,null,null)
D.LA=new A.h(1,0.8470588235294118,0.7098039215686275,0.4196078431372549,C.c)
D.O2=new A.h(1,0.5450980392156862,0.3568627450980392,0.19607843137254902,C.c)
D.Ye=x([D.LA,D.O2],y.O)
D.XC=new G.eY(C.bX,C.bA,C.aJ,D.Ye,null,null)
D.Pl=new A.h(1,0.08627450980392157,0.48627450980392156,0.8196078431372549,C.c)
D.LS=new A.h(1,0.5529411764705883,0.8470588235294118,0.8980392156862745,C.c)
D.ZN=x([D.Pl,D.LS],y.O)
D.XG=new G.eY(C.bX,C.bA,C.aJ,D.ZN,null,null)
D.PP=new A.h(1,0.07058823529411765,0.42745098039215684,0.5686274509803921,C.c)
D.PK=new A.h(1,0.20784313725490197,0.7176470588235294,0.6980392156862745,C.c)
D.Z4=x([D.PP,D.PK],y.O)
D.XK=new G.eY(C.bX,C.bA,C.aJ,D.Z4,null,null)
D.YX=x([0,0.42,1],y.n)
D.al=new B.iz(0,"rock")
D.bk=new B.iz(1,"tree")
D.oB=new B.iz(2,"ruin")
D.bt=new B.iz(3,"treasure")
D.Bk=new B.iz(4,"foliage")
D.Bl=new B.iz(5,"dock")
D.Bm=new B.iz(6,"gateway")
D.Zv=x([D.al,D.bk,D.oB,D.bt,D.Bk,D.Bl,D.Bm],A.S("m<iz>"))
D.rB=new A.h(0,0.050980392156862744,0.09411764705882353,0.18823529411764706,C.c)
D.Nr=new A.h(0.7843137254901961,0.3568627450980392,0.2901960784313726,0.5254901960784314,C.c)
D.MK=new A.h(0.7058823529411765,0.19215686274509805,0.17647058823529413,0.3843137254901961,C.c)
D.a__=x([D.rB,D.rB,D.Nr,D.MK],y.O)
D.jT=x([],A.S("m<a0<c>>"))
D.jW=x([],y.g)
D.eo=new B.oU(0,"trainingGhost")
D.hS=new B.oU(1,"rockCrab")
D.a0X=x([D.eo,D.hS],A.S("m<oU>"))
D.a5D=new A.ff(C.K,38)
D.a5E=new A.ff(C.K,6)
D.a6F=new A.c(0,-150)
D.a6H=new A.c(0,-34)
D.pe=new A.w(130,82)
D.Qd=new A.h(1,1,0.9411764705882353,0.6039215686274509,C.c)
D.NS=new A.h(1,1,0.615686274509804,0.1411764705882353,C.c)
D.Mf=new A.h(0,0.33725490196078434,0.1450980392156863,0.09411764705882353,C.c)
D.a28=x([D.Qd,D.NS,D.Mf],y.O)
D.ad1=new I.lr(C.M,0.5,C.aJ,null,0,D.a28,null,null)
D.afR=new A.i(42,-178,76,0)
D.ago=new A.i(-105,-42,105,0)
D.agp=new A.i(-12,-132,12,0)
D.agq=new A.i(-25,-76,25,0)
D.agr=new A.i(-34,-5,82,17)
D.F_=new A.i(-41,-143,41,0)
D.ags=new A.i(-42,-32,42,-24)
D.agt=new A.i(-42,-48,42,0)
D.agu=new A.i(-55,-118,55,0)
D.agv=new A.i(-76,-178,76,-144)
D.agw=new A.i(-76,-178,-42,0)
D.anA=new A.t(!0,D.iQ,null,null,null,null,11,C.V,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null)
D.anR=new A.t(!0,C.i,null,null,null,null,null,null,null,null,null,null,1.45,null,null,null,null,null,null,null,null,null,null,null,null,null)
D.anS=new A.t(!0,E.cD,null,null,null,null,null,C.c1,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null)
D.ap0=new A.t(!0,E.cD,null,null,null,null,9,C.V,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null)
D.aqw=new A.af("Loot Chest",null,null,null,null,null,null,null,null,null)
D.aoN=new A.t(!0,C.i,null,null,null,null,11,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null)
D.aqR=new A.af("WASD / ARROWS MOVE  \u2022  SPACE SWORD  \u2022  CLICK FIRE",null,D.aoN,null,null,null,null,null,null,null)})()};
(a=>{a["+BgPjzvRYMw3pHSjDHNMV1IM0ss="]=a.current})($__dart_deferred_initializers__);